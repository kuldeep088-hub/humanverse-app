...
export function ProfileSidebarCard({
  ...
  return (
    <div className="w-full space-y-3">
      ...
      <div className="overflow-hidden rounded-2xl border border-gray-200/90 bg-white shadow-xs dark:border-gray-800 dark:bg-gray-900 transition-all duration-200 hover:shadow-md">
        {/* Banner Cover matching the screenshot style */}
        <div className="relative h-20 sm:h-24 w-full bg-gradient-to-r from-[#1e293b] via-[#0f172a] to-[#1e3a8a] overflow-hidden">
        ...
        <div className="relative px-4 pb-4 pt-0">
          ...
          <div className="-mt-10 sm:-mt-11 mb-2.5 flex items-end justify-between">
            ...
            >
              <div className="rounded-full p-1 bg-white dark:bg-gray-900 ring-2 ring-white dark:ring-gray-900 shadow-md transition-transform duration-200 group-hover:scale-105">
                <Avatar
                  src={avatarUrl}
          ...
          <div className="space-y-1">
            ...
            <div className="pt-2 flex items-center gap-2 border-t border-gray-100 dark:border-gray-800/80">
              <div className="flex h-5 w-5 items-center justify-center rounded-sm bg-slate-300 dark:bg-slate-700 text-[10px] font-bold text-slate-800 dark:text-slate-200">
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 px-4 py-2.5 space-y-1.5 text-xs">
          <Link
            href="/app/profile/me"
            className="flex items-center justify-between text-gray-600 hover:text-gray-950 dark:text-gray-400 dark:hover:text-white transition-colors group"
          >
            <span className="font-semibold text-gray-600 dark:text-gray-400">Profile viewers</span>
          ...
          <Link
            ...
            className="flex items-center justify-between text-gray-600 hover:text-gray-950 dark:text-gray-400 dark:hover:text-white transition-colors group"
          >
            <span className="font-semibold text-gray-600 dark:text-gray-400">Post impressions</span>
        ...
        <div className="border-t border-gray-100 dark:border-gray-800 px-4 py-2.5 bg-gray-50/60 dark:bg-gray-900/50">
          <Link
            href="/app/journal"
            className="flex items-center gap-2 text-xs font-bold text-gray-800 dark:text-gray-200 hover:text-primary transition-colors py-0.5"
          >
      ...
      <div className="rounded-2xl border border-gray-200/90 bg-white p-3.5 shadow-xs dark:border-gray-800 dark:bg-gray-900 text-xs space-y-2">
        ...
        <div className="space-y-1">
          <Link
            href="/app/circles"
            className="flex items-center gap-2 px-2 py-1.5 rounded-lg text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors font-semibold"
          >
          ...
          {pseudonym && (
            ...
            >
              ...
              <span>Alias: @{pseudonym.display_name}</span>
            </Link>
          )}
        </div>
      </div>
